    ...
    function renderGoogleButton() {
        if (window.google && googleBtnContainer) {
            ...
            window.google.accounts.id.renderButton(
                googleBtnContainer,
                { theme: 'outline', size: 'large', width: 320, text: isLogin ? 'signin_with' : 'signup_with', shape: 'rectangular' }
            );
        }
    }
    ...
    <div class="auth-container shell">
        ...
        <div class="auth-card">
            <div class="toggle-group">
                <button class="toggle-btn" class:active={isLogin} onclick={() => isLogin = true}>Sign In</button>
                <button class="toggle-btn" class:active={!isLogin} onclick={() => isLogin = false}>Sign Up</button>
            </div>
            ...
            <form onsubmit={handleManualAuth} class="auth-form">
                ...
                <NeoButton type="submit" class="w-full mt-4">
