<script lang="ts">
    ...
    async function changePassword() {
        if (!oldPassword || !newPassword) { alert('Fill in both password fields.'); return; }
        const token = getToken();
        try {
            ...
            const data = await res.json();
            if (res.ok) { alert('Password changed successfully!'); oldPassword = ''; newPassword = ''; }
    ...
    async function clearSnapshots() {
        ...
        try {
            ...
            if (res.ok) { alert('All financial snapshots cleared.'); showClearConfirm = false; }
        ...
        <div class="settings-grid">
            ...
            <section class="settings-card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="display-name" bind:value={settings.display_name} placeholder="Your Name" />
                </div>
                <div class="form-group">
            ...
            <section class="settings-card danger-card">
                ...
                <NeoButton variant="secondary" onclick={exportData}>
                ...
                {#if showClearConfirm}
                    <div class="confirm-box">
                        ...
                        <div class="confirm-actions">
                            ...
                            <NeoButton variant="secondary" onclick={() => showClearConfirm = false}>Cancel</NeoButton>
                        </div>
                    </div>
                {:else}
                ...
                {#if showDeleteConfirm}
                    <div class="confirm-box">
                        <p>⚠️ This is <strong>irreversible</strong>. Your account and all data will be permanently deleted.</p>
                        <div class="confirm-actions">
                            <NeoButton onclick={deleteAccount}>Delete Account Permanently</NeoButton>
                            <NeoButton variant="secondary" onclick={() => showDeleteConfirm = false}>Cancel</NeoButton>
                        </div>
                    </div>
                {:else}
